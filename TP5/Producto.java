...
public class Producto
{
     ...
     */
    Producto (int p_codigo, String p_rubro, String p_desc, int p_existMin, double p_porcPtoRepo, int p_stock, double p_costo,  Laboratorio p_lab)
    {
        this.setCodigo(p_codigo);
        this.setRubro(p_rubro);
        this.setDescripcion(p_desc);
