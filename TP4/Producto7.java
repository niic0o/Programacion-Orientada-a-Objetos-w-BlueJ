 ...
 * @version version 1.2 - 14/09/2017
 */
public class Producto7
{
     ...
     */
    Producto7 (int p_codigo, String p_rubro, String p_desc, double p_costo, double p_porcPtoRepo, int p_existMin, Laboratorio7 p_lab)
    {
     ...
     * @param p_lab datos de tipo Laboratorio (nombre domicilio y telefono).
     */
    Producto7 (int p_codigo, String p_rubro, String p_desc, double p_costo, Laboratorio7 p_lab)
    {
        this.setCodigo(p_codigo);
        this.setRubro(p_rubro);
        this.setDescripcion(p_desc);
     ...
     */
    Producto7 (int p_codigo, String p_rubro, String p_desc, int p_existMin, double p_porcPtoRepo, int p_stock, double p_costo,  Laboratorio7 p_lab)
    {
        this.setCodigo(p_codigo);
        this.setRubro(p_rubro);
        this.setDescripcion(p_desc);
    ...
    private void setLab (Laboratorio7 p_lab)
    {this.lab = p_lab;}
