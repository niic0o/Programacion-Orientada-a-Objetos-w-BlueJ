...
{   //atributos
    ...
    Laboratorio7 (String p_nom, String p_dom, String p_tel, int p_compraMin, int p_diaEnt)
        {
     ...
     * @param p_tel un numero telefonico para contactarse    
       */
    //sobrecarga
    Laboratorio7 (String p_nom, String p_dom, String p_tel)
        {
            this.setNombre(p_nom);
            this.setDomicilio(p_dom);
            this.setTelefono(p_tel);
    ...
    //metodos
    /** @return devuelve los dias habiles restantes para la entrega, considerando que los meses tienen distinta cantidad de dias*/ 
    ...
    //getActualMaximun(Calendar.) retorna el maximo valor del campo especificado.
    {
        ...
        if (diaHoy < this.getDiaEntrega()){
            ...
            return fechaHoy.getActualMaximum(Calendar.DATE) - diaHoy + this.getDiaEntrega();
        }
    }
